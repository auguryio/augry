...
public class Player extends Character {
	...
	public void onLogin() {
		...
		getPacketSender().sendMessage("Welcome to Augurypkz.");
		getPacketSender().sendMessage("This is Beta v.01 Report any Bugs & Combat Glitches To JParks or Another Dev.");
